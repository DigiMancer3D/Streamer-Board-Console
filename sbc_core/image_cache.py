...
class StickyImageRenderer:
    ...
    def render(self, pin: PinImageState, output_scale: float = 1.0, use_cache: bool = True) -> ImageTk.PhotoImage:
        ...
        # Static/sticky images cache. Animated frames never cache because
        # their transform changes every tick and can leak memory quickly.
        if use_cache:
